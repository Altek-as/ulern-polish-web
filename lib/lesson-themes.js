...
const LESSON_THEMES = {
  ...
  18: {
    theme: 'home_apartment',
    scenePrompt: 'Modern Polish apartment interior, bright living room with large windows showing city view, cozy sofa with colorful pillows, open kitchen with breakfast bar, bookshelf with Polish books, balcony with plants, warm afternoon sunlight, minimalist Scandinavian-meets-Polish aesthetic, photorealistic 8k cinematic',
    avatarPrompt: 'Friendly Polish person, 30s, casual home outfit, standing in modern bright apartment living room, warm smile, holding coffee cup, urban Polish home setting, natural soft lighting, 8k photorealistic portrait',
    avatarStyle: 'portrait_home'
  },
  19: {
    theme: 'polish_kitchen',
    scenePrompt: 'Traditional Polish kitchen interior, rustic wooden table set for dinner, fresh pierogi on large plate, copper pots hanging on wall, Polish pottery and folk patterns, warm golden hour light through window with lace curtains, herbs hanging to dry, cozy Polish home kitchen, photorealistic 8k cinematic',
    avatarPrompt: 'Warm Polish grandmother or mother, 50s-60s, traditional Polish apron, standing at kitchen counter with fresh pierogi, warm encouraging smile, rustic Polish kitchen setting, golden hour natural lighting, 8k photorealistic portrait',
    avatarStyle: 'portrait_cook'
  },
  20: {
    theme: 'polish_wigilia',
    scenePrompt: 'Traditional Polish Wigilia Christmas Eve dinner table, opulent spread with fish dishes, pierogi, beetroot soup, advent wreath with candles, elegant white tablecloth, Christmas decorations, warm candlelight, family celebration atmosphere, polish Christmas traditions, photorealistic 8k cinematic',
    avatarPrompt: 'Warm smiling Polish family member, 40s, elegant casual outfit, standing at beautifully decorated Christmas table with candles and festive Polish dishes, intergenerational family setting, warm candlelight glow, 8k photorealistic portrait',
    avatarStyle: 'portrait_family'
  }
};
